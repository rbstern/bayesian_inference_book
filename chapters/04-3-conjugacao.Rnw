...
<<normal_gamma, cache=TRUE, fig.pos="t", fig.height=5, fig.width=8, fig.cap="Distribuições a priori e a posteriori (depois de observamos um indivíduo com 1,8m) para a altura média de um brasileiro", fig.align="center">>=
library(ggplot2)
library(gridExtra)
...
plot_densidade <- function(grid_bivariado, hparam, title)
{
...
aux1 = plot_densidade(grid_bivariado, hparam_prior, "Prior")
aux2 = plot_densidade(grid_bivariado, 
                      atualiza(hparam_prior, altura), "Posterior")
